...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"Textures/pencil_wood.jpg",
		"pencil_wood");
	bReturn = CreateGLTexture(
		"Textures/pencil_lead.jpg",
		"pencil_lead");
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[0].position", 0.0f, 1.0f, 0.0f);
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.0f, -3.0f, 4.0f);
	...
	SetTextureUVScale(6, 1);
	SetShaderTexture("pencil_wood");
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, -3.0f, 4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-6.0f, 1.0f, 4.0f);
	...
	SetShaderColor(.6, .2, .2, 1);
	//SetShaderTexture("none");
	SetShaderMaterial("wood");
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-6.0f, 1.0f, 4.1f);
	...
	// CUP HANDLE
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, .5f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.2f, 1.0f, 5.0f);
